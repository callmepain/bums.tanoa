...
private "_value";
if ((time - life_action_delay) < 1.5) exitWith {[(format [localize "STR_NOTF_ActionDelay"]),"Hinweis","Yellow"] call MSG_fnc_handle; _this setVariable ["inUse",false,true];};
...
if (!isNil "_value") exitWith {
    ...
    [(format [localize "STR_NOTF_PickedMoney",[_value] call life_fnc_numberText]),"Hinweis","Green"] call MSG_fnc_handle;
    CASH = CASH + _value;
