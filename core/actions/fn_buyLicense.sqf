...
if (CASH < _price) exitWith {[(format [localize "STR_NOTF_NE_1",[_price]call life_fnc_numberText,localize _displayName]),"Fehler","Red"] call MSG_fnc_handle;};
CASH = CASH - _price;

[0] call SOCK_fnc_updatePartial;

[(format [localize "STR_NOTF_B_1", localize _displayName,[_price] call life_fnc_numberText]),"Hinweis","Green"] call MSG_fnc_handle;
