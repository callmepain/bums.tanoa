...
if (count _sellers isEqualTo 0) exitWith {[(format [localize "STR_Cop_DealerQuestion"]),"Hinweis","Yellow"] call MSG_fnc_handle;	}; //No data.
...
[(parseText format [(localize "STR_Cop_DealerMSG")+ "<br/><br/>%1",_names]),"Hinweis","Green"] call MSG_fnc_handle;	
