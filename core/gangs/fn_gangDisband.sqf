...
if (_action) then {
    [(format [localize "STR_GNOTF_DisbandGangPro"]),"Hinweis","Green"] call MSG_fnc_handle;
    ...
    [(format [localize "STR_GNOTF_DisbandGangCanc"]),"Hinweis","Yellow"] call MSG_fnc_handle;
};
