...
if (getPlayerUID player isEqualTo (group player getVariable "gang_owner")) exitWith {[(format [localize "STR_GNOTF_LeaderLeave"]),"Hinweis","Yellow"] call MSG_fnc_handle;};
