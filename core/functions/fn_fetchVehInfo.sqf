...
/*
	...
	13: KW
*/
private ["_class","_scope","_picture","_displayName","_vehicleClass","_side","_faction","_superClass","_speed","_armor","_seats","_hp","_fuel","_kw"];
...
_kw = FETCH_CONFIG2(getNumber,"CfgVehicles",_class,"enginePower");
_fuel = FETCH_CONFIG2(getNumber,"CfgVehicles",_class,"fuelCapacity");
_hp = round(_kw * 1.359621617);
_fuelConsumptionRate = FETCH_CONFIG2(getNumber,"CfgVehicles",_class,"fuelConsumptionRate");

{
	if(_class in life_container) then
	{
		_picture = format["icons\container\%1.paa",_class];
...
//Return
[_class,_scope,_picture,_displayName,_vehicleClass,_side,_faction,_superClass,_speed,_armor,_seats,_kw,_fuel,_hp,_fuelConsumptionRate];
