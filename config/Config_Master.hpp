...
/* Database Related Settings */
    ...
    save_position = true; //Save  location?
    save_position_restart = false; //Save location only between restarts. After a server restart you'll have to spawn again.
	save_medical_stats = true; //Save ace medical status.
    /* !!!TO SAVE POSITION BETWEEN RESTARTS save_position MUST BE TRUE!!! */
...
/* System Settings */
    ...
    bank_adac = 20000; //Amount of cash in bank for new medics

    paycheck_cop = 1600; //Payment for cops
    paycheck_civ = 800; //Payment for civillians
    paycheck_med = 1600; //Payment for medics
    paycheck_adac = 1600; //Payment for medics
    ...
    vehicle_purchase_multiplier = 1; // Vehicle Buy Price = Config_Vehicle price * multiplier
    /* Vehicle Rental Prices */
    vehicle_rental_multiplier = .6666666666666667; // Vehicle Rental Price = Config_Vehicle price * multiplier
    /* Vehicle Sell Prices */
	...
	vehicle_insurance_multiplier = .35; //Civilian Vehicle Insurance Price = Vehicle Buy Price * multiplier 
