...
class CfgRemoteExec {
    class Functions {
		...
		F(life_fnc_zeige_ausweis,CLIENT)
        ...
        F(life_fnc_impoundVehiclesMenu,CLIENT)
        ...
        F(TON_fnc_getImpoundVehicles,SERVER)
        F(TON_fnc_getVehicles,SERVER)
        F(TON_fnc_handleBlastingCharge,SERVER)
        F(TON_fnc_healplayer,SERVER)
        ...
        F(TON_fnc_spawnImpoundVehicle,SERVER)
        ...
        F(HC_fnc_wantedPardon,HC)
        F(HC_fnc_wantedPerson,HC)
        F(HC_fnc_wantedPunish,HC)
        F(HC_fnc_wantedRemove,HC)
        F(HC_fnc_wantedTicket,HC)
